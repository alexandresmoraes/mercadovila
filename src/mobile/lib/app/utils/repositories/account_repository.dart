...
class AccountRepository implements IAccountRepository {
  ...
  @override
  Future<Either<ResultFailModel, NewAccountResponseModel>> newAccount(NewAccountModel newAccountModel) async {
    try {
      ...
      return Left(ResultFailModel(isValid: false, hasError: false, errors: []));
    }
  }

  @override
  Future<Either<ResultFailModel, String>> updateAccount(String id, UpdateAccountModel updateAccountModel) async {
    try {
