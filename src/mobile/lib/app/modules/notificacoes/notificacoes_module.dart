...
import 'package:vilasesmo/app/modules/notificacoes/notificacoes_edit_page.dart';
import 'package:vilasesmo/app/modules/notificacoes/notificacoes_page.dart';
import 'package:vilasesmo/app/utils/repositories/notificacoes_repository.dart';
...
class NotificacoesModule extends Module {
  ...
  final List<ModularRoute> routes = [
    ChildRoute(Modular.initialRoute,
        child: (_, args) => const NotificacoesPage(),
